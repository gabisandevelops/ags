			...
			foreach ( $templates_array as $template => $properties ) {
				...
				<div class="install-theme-info sktb-theme-info <?php echo esc_attr( $template ); ?>"
					...
					<div class="theme-details">
                        ...
                        <p><a href="<?php echo esc_url('https://www.sktthemes.org/shop/all-themes/');?>" target="_blank"><?php esc_html_e('Buy All Themes', 'skt-templates'); ?></a><i><?php esc_html_e( ' (291+ templates) for just $99. Features include inner pages, page/post layouts, header/footer layouts, site layout, color/font options and 1 year unlimited support.', 'skt-templates' ); ?></i></p>
					</div>
					<?php
